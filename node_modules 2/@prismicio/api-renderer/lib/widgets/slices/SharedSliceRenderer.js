...
const SharedSliceRenderer = (ctx) => ({
    renderV1(content, fetch) {
        ...
        const primaryValue = (0, StaticWidgetRenderer_1.default)(ctx).renderObjectOfStaticWidgetV1(content.primary, getFetchField(content.variation, "nonRepeat", fetch));
        return {
    ...
    renderV2(def, content, fetch) {
        ...
        const primaryValue = (0, StaticWidgetRenderer_1.default)(ctx).renderObjectOfStaticWidgetV2(content.primary, getFetchField(content.variation, "nonRepeat", fetch), variation.primary || {}, {
            withFetch: "filter",
        }, {
            default: "default",
            withFetch: "filter",
    ...
    renderMocks(def, content) {
        ...
        const primaryValue = (0, StaticWidgetRenderer_1.default)(ctx).renderObjectOfStaticWidgetMocks(content.primary, variation.primary || {});
        return {
            variation: content.variation,
            version: variation.version,
            items: itemsValue,
