...
import { GroupMock, NestableWidgetMock } from "."
...
function randomPrimaryBlock(
	fieldsDefs: Array<[string, SlicePrimaryWidget]>,
	mockConfigs?: Partial<Record<string, SlicePrimaryWidgetMockConfig>>,
): Array<[string, SlicePrimaryContent]> {
	return fieldsDefs.map(([key, field]: [string, SlicePrimaryWidget]) => {
