...
const _1 = require(".");
function randomPrimaryBlock(fieldsDefs, mockConfigs) {
    return fieldsDefs.map(([key, field]) => {
        ...
        switch (field.type) {
            case customtypes_1.GroupFieldType: {
                ...
                return [key, _1.GroupMock.generate(field, mockConfig)];
            }
            default: {
    ...
    return {
        ...
        primary: (() => {
            if (!variationDef.primary)
                return {};
            return randomPrimaryBlock(Object.entries(variationDef.primary), config === null || config === void 0 ? void 0 : config.primaryFields).reduce((acc, [k, v]) => ({ ...acc, [k]: v }), {});
        })(),
        items: (() => {
