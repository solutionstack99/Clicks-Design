import { parse as parse_1 } from "../../../cookie/index.js";
import * as require$$2 from "url";
import { _optionalChain } from './../_node_modules/@sentry/utils/esm/buildPolyfills/_optionalChain.js';
import { isPlainObject, isString } from './../_node_modules/@sentry/utils/esm/is.js';
import { normalize } from './../_node_modules/@sentry/utils/esm/normalize.js';
import { stripUrlQueryAndFragment } from './../_node_modules/@sentry/utils/esm/url.js';
  ...
  include.forEach((key) => {
    switch (key) {
      ...
      case "cookies": {
        ...
        // come off in v8
        req.cookies || headers.cookie && parse_1(headers.cookie) || {};
        break;
      }
      case "query_string": {
...
function extractQueryParams(req) {
  ...
  require$$2.parse(originalUrl).query || void 0;
}
export {
