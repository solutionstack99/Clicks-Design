...
import { d as dist } from "../../../../https-proxy-agent/dist/index.js";
...
function makeNodeTransport(options) {
  ...
  const agent = proxy ? new dist.HttpsProxyAgent(proxy) : new nativeHttpModule.Agent({ keepAlive, maxSockets: 30, timeout: 2e3 });
