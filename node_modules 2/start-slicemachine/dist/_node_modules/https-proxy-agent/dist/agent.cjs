...
const agent = require("../../../_virtual/agent.cjs");
...
const index = require("../../agent-base/dist/src/index.cjs");
require("./parse-proxy-response.cjs");
const parseProxyResponse = require("../../../_virtual/parse-proxy-response.cjs");
...
Object.defineProperty(agent.__exports, "__esModule", { value: true });
...
const agent_base_1 = index.src;
const parse_proxy_response_1 = __importDefault(parseProxyResponse.__exports);
...
agent.__exports.default = HttpsProxyAgent;
