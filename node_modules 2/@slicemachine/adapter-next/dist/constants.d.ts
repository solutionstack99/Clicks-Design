 ...
 */
export declare const DEFAULT_ENVIRONMENT_VARIABLE_FILE_PATH = ".env.local";
/**
 * The file paths at which environment variables will be read in order from
 * lowest priority to highest priority.
 */
export declare const ENVIRONMENT_VARIABLE_PATHS: string[];
/**
 * The name of the environment variable that stores the active Prismic
 * environment.
 */
export declare const PRISMIC_ENVIRONMENT_ENVIRONMENT_VARIABLE_NAME = "NEXT_PUBLIC_PRISMIC_ENVIRONMENT";
